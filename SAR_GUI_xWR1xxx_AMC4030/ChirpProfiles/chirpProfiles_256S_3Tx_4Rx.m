function params = chirpProfiles_256S_3Tx_4Rx()
...
params.Slope_MHzperus               =	70.295; % MHz/us
params.Idle_Time_us                 =	7;      % us
params.Tx_Start_Time_us             =   0;      % us
params.Adc_Start_Time_us            =	4.66;   % us
params.Samples_per_Chirp            =	256; 
params.Sampling_Rate_ksps           =	5000;	% ksps
params.Ramp_End_Time_us             =	56.9;   % us
